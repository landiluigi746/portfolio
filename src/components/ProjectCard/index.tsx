  ...
  return (
    <div className="w-fit bg-zinc-900 text-zinc-100 outline-1 outline-zinc-600 rounded-2xl hover:bg-neutral-800 hover:scale-105 not-sm:scale-90 transition-all">
      ...
      <div className="w-96 mt-4 not-sm:w-svw">
        <h3 className="font-extrabold text-3xl text-center">{name}</h3>
        <p className="font-semibold mx-4 mt-4 text-justify">{description}</p>
      </div>
      ...
      <div className="flex flex-row justify-center items-center mt-2 mb-2">
        {githubLink && (
          <a
            href={githubLink}
            className="font-semibold bg-green-700 rounded-2xl text-slate-50 shadow-sm transition-all hover:shadow-lg hover:bg-green-800 hover:scale-105 p-2 m-2"
            target="_blank"
          >
            Github Link
          </a>
